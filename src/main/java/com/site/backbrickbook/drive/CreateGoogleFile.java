package com.site.backbrickbook.drive;
...
public class CreateGoogleFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.io.File uploadFile = new java.io.File("C:\\Downloads\\lego_imperial.png");

        // Create Google File:

        File googleFile = createGoogleFile(null, "image/png", "teste.png", uploadFile);
